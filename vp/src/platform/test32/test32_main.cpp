...
int sc_main(int argc, char **argv) {
	...
	SimpleBus<2, 3> bus("SimpleBus", bus_trace, opt.break_on_transaction);
...

	{
		...
		if (opt.isa.find('G') != std::string::npos)
			core.csrs.misa.fields.extensions |=
			    core.csrs.misa.M | core.csrs.misa.A | core.csrs.misa.F | core.csrs.misa.D;
