...
class FU540_I2C : public sc_core::sc_module, public I2C_IF {
   public:
    ...
    uint8_t reg_prer_lo =   0xFF;
    uint8_t reg_prer_hi =   0xFF;
    uint8_t reg_ctr =       0x00;
    uint8_t reg_txr =       0x00;
    uint8_t reg_rxr =       0x00;
    uint8_t reg_cr =        0x00;
    uint8_t reg_sr =        0x00;
    uint8_t dummy =         0x00;
